...
export default function PinnedCards({ data }) {
  return (
    <div className="group relative border-lime-500 border-1 bg-lime-600 w-[100px] flex flex-col p-2">
      <img
        src={data.image}
        className="w-full object-cover aspect-square"
        alt=""
      />
      <div className="flex flex-col opacity-0 group-hover:opacity-100 transition-opacity duration-300 absolute bottom-full left-1/2 transform -translate-x-1/2 bg-gray-800 p-2">
